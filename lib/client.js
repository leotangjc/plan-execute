...
// src/client.ts
function apply(ctx) {
  const diag = { called: true, hasGet: typeof ctx.get === "function", slotsViaGet: void 0, slotsViaProp: void 0, settingsScopeViaGet: void 0, settingsScopeViaProp: void 0, error: void 0 };
  try {
