...
export declare const SETTINGS_NAMESPACE = "dsh-plan-execute";
/** 设置 schema：UI 依据它渲染表单。 */
export declare const PlanExecuteSettingsSchema: Schema<Schemastery.ObjectS<{
    mode: Schema<"light" | "heavy", "light" | "heavy">;
    autoTrigger: Schema<boolean, boolean>;
    defaultSlug: Schema<string, string>;
}>, Schemastery.ObjectT<{
    mode: Schema<"light" | "heavy", "light" | "heavy">;
    autoTrigger: Schema<boolean, boolean>;
    defaultSlug: Schema<string, string>;
...
export declare function ns(): unknown;
